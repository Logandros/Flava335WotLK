...
(@Id+0, "You do not have the required level. This destination requires level", "", "Ihr habt nicht das erforderliche Level. Dieses Ziel ben�tigt Level"),
(@Id+1, "You do not have enough money. The price for teleportation is", "", "Ihr habt nicht genug Geld. Der Preis f�r die Teleportation betr�gt"),
(@Id+2, "You are in combat. Come back later", "", "Ihr seid in einem Kampf verwickelt. Kommt sp�ter wieder.");